(function () {
  ...
  class TabokGPUBoard {
    ...
    drawHauntingPortal() {
      ...
      // The stateful Eclipse Well is rendered once in the SVG interaction layer so
      // WebGL/WebGPU and compatibility clients see the exact same synchronized portal.
      root.visible = false;
